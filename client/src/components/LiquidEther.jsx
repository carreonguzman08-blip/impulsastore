  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      onDocumentMouseMove(event) {
        ...
        // MODIFICACIÓN CLAVE: Si se detecta un evento de mouse, 
        // desactiva inmediatamente el modo automático y activa el control del usuario.
        if (this.isAutoActive && !this.hasUserControl) {
            this.takeoverActive = false; // Desactivamos la transición de 'takeover' si existía
            this.hasUserControl = true;
            this.isAutoActive = false;
        }
        
        // Lógica original de transición (la mantenemos solo en caso de que sea útil)
        ...
        */
        ...
        // Establece las coordenadas del mouse
